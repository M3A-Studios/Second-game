package nl.rocmondriaan.greenfoot.game.entities;

import greenfoot.Actor;
import greenfoot.Greenfoot;
import greenfoot.GreenfootImage;
import nl.rocmondriaan.greenfoot.game.*;
import nl.rocmondriaan.greenfoot.game.blocks.normal.Coins;
import nl.rocmondriaan.greenfoot.game.blocks.normal.Lava;
import nl.rocmondriaan.greenfoot.game.blocks.normal.Spikes;
import nl.rocmondriaan.greenfoot.game.blocks.special.*;
import nl.rocmondriaan.greenfoot.game.entities.enemies.Slime;
import nl.rocmondriaan.greenfoot.game.hud.PopUp;
import nl.rocmondriaan.greenfoot.game.world.level.DesertStorm;
...
public class Player extends Physics {
    ...
    public static boolean carryingObject;
    ...
    public static String itemToDrop;
    public static int dropCooldown = 60;
    public static int pickUpCooldown;
    public static boolean canTakeDmg;
    private int deathTimer;
    public static String lastDroppedItem;
    public static int lastItemCD = 30;
